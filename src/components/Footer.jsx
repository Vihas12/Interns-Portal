        ...
        <div className='py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
          ...
          <div className='space-y-4'>
            ...
            <p className='text-gray-300 text-sm leading-relaxed'>
              ...
              Build your career with hands-on experience at top companies.
            </p>
          ...
          <div className='space-y-4'>
            ...
            <ul className='space-y-2'>
              <li>
                <Link to='/' className='text-gray-300 hover:text-blue-400 text-sm transition-colors duration-200'>
                  Home
                </Link>
              </li>
              <li>
                <Link to='/internships' className='text-gray-300 hover:text-blue-400 text-sm transition-colors duration-200'>
                  Browse Internships
                </Link>
              </li>
              <li>
                <Link to='/about' className='text-gray-300 hover:text-blue-400 text-sm transition-colors duration-200'>
                  About Us
                </Link>
              </li>
              <li>
                <Link to='/contact' className='text-gray-300 hover:text-blue-400 text-sm transition-colors duration-200'>
                  Contact
                </Link>
              </li>
            </ul>
